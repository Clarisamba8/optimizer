"""Entry point: python theory/figures/ch05/generate_figures.py

Run from the repository root:
    python theory/figures/ch05/generate_figures.py

Or as a module (preferred — no sys.path manipulation needed):
    python -m theory.figures.ch05.generate_figures
"""
...
from theory.figures.ch05._registry import build_generators  # noqa: E402
