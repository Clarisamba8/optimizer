"""Entry point: python theory/figures/ch01/generate_figures.py

Run from the repository root:
    python theory/figures/ch01/generate_figures.py

Or as a module (preferred — no sys.path manipulation needed):
    python -m theory.figures.ch01.generate_figures
"""
...
# (i.e. python theory/figures/ch01/generate_figures.py).  When run as a
# module (`python -m theory.figures.ch01.generate_figures`) the interpreter
